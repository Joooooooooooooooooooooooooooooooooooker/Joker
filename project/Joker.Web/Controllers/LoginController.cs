...
using Joker.Application.SystemSecurity;
using System;
...
namespace Joker.Web.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult CheckLogin(string username, string password, string code)
        {
            ...
            try
            {
                if (Session["Joker_session_verifycode"].IsEmpty() || Md5.md5(code.ToLower(), 16) != Session["Joker_session_verifycode"].ToString())
                {
